	...
	<form action="zaiko_ichiran.php" method="post" id="myform" name="myform">
		<div id="pagebody">
			...
			<div id="left">
				...
				<button type="submit" id="btn1" formmethod="POST" name="decision" value="8" formaction="new_product.php">新商品追加</button>

				<button type="submit" id="btn1" formmethod="POST" name="decision" value="8" formaction="delete_product.php">商品削除</button>
